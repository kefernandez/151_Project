...
# DVE reload session
# Saved on Fri Dec 1 14:11:32 2017
# Designs open: 1
...
#<Session mode="Reload" path="/home/cc/eecs151/fa17/class/eecs151-aai/project/vcs-sim-rtl/DVEfiles/session.tcl" type="Debug">
...
# MDI window settings
set Wave.1 Wave.1
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 418} {child_wave_right 1019} {child_wave_colname 207} {child_wave_colvalue 207} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_wv_zoom_timerange -id ${Wave.1} 999818 1348706
gui_list_add_group -id ${Wave.1} -after {New Group} {Group1}
gui_list_add_group -id ${Wave.1} -after {New Group} {Group2}
gui_list_select -id ${Wave.1} {rocketTestHarness.dut.mem.icache.cpu_resp_data }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group Group2  -item rocketTestHarness.dut.mem.icache.write_enable_bar3 -position below

gui_marker_move -id ${Wave.1} {C1} 1053252
gui_view_scroll -id ${Wave.1} -vertical -set 74
